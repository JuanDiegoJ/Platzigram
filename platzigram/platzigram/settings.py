...
SECRET_KEY = '$ly9r_(d82k*i2$509kxdr@egi=7u*s(j_2d7al03z%yd0rchj'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            #Especifica dónde van a estar los templates
...
#Métodos para buscar archivos en nuestro directorio
STATICFILES_FINDERS = [
